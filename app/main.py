...
@app.get("/{repo_type}s/{repo_id}/user-access-request/{status}")
...
@app.post("/{repo_type}s/{repo_id}/user-access-request/handle")
...
@app.post("/models/{repo_id}/user-access-request/grant")
